...
ansible-galaxy install --ignore-errors https://github.com/geerlingguy/ansible-role-mysql.git,,geerlingguy.mysql
ansible-galaxy install --ignore-errors https://github.com/geerlingguy/ansible-role-drush.git,,geerlingguy.drush
